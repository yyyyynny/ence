...
const SECTIONS=[
  {id:'ms',  label:'중학',    sub:'중학교 과학',
   note:'이온식(SO₄²⁻ 등)과 앙금 생성 반응은 2022 개정에서 중학교 과정에서 빠졌어요. 없어진 게 아니라 옮겨간 거라, 이온식은 「고2 화학」에, 앙금은 「심화」에 있어요.'},
  {id:'is1', label:'통합과학', sub:'고1',
   note:'결합 차수(단일·이중·삼중)는 고2 「화학」에서 배워요.'},
  {id:'chem',label:'고2 화학', sub:'고2 선택',
   note:'원자 구조와 오비탈은 2022 개정 「화학」에서 빠졌어요. 전자껍질에 2·8·18개가 들어가는 이유가 궁금하면 「심화」에 있어요.'},
  {id:'plus',label:'심화',    sub:'시험 범위 아님',
   note:'지금 교육과정에는 없는 내용이에요. 시험에는 안 나오지만 알아두면 이해가 깊어져요.'}
];
